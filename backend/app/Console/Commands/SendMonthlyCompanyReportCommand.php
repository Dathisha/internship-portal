...
{
    protected $signature = 'reports:send-monthly {--month= : Month number (1-12)} {--year= : Year (4 digits)}';
    ...
    public function handle()
    {
        ...
        if (class_exists(\Barryvdh\DomPDF\Facade\Pdf::class)) {
            ...
            // Basic PDF fallback generator if DomPDF is unavailable
        ...
        try {
            ...
            $this->info("Monthly report email successfully sent to {$recipient} for {$monthName} {$year} (" . count($applications) . " applications).");
    ...
    {
        // Minimal PDF stream generator if PDF library is not present
